...
public class FollowerConstants {
    ...
    private static double xMovement = 78.038525;
    private static double yMovement = 62.8205333333;
    ...
    public static double mass = 11.61196;
    ...
    public static double forwardZeroPowerAcceleration = -39.9356;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -70.1554;
    ...
    public static double zeroPowerAccelerationMultiplier = 2.5; //default 4
