...
public class RedFarAutoLoadingZoneSpamming extends LinearOpMode {
    ...
    */
    ...
    private final Pose grab1Pose = new Pose(12.25, 134, Math.toRadians(180)); // 12.25, 134 Second pickup spot

    private final Pose pickup2Pose = new Pose(40, 126, Math.toRadians(180)); //Third pickup spot
    private final Pose grab2Pose = new Pose(12.25, 122, Math.toRadians(180)); // Second pickup spot
