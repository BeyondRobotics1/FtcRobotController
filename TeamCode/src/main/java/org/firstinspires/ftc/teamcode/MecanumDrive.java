...
public class MecanumDrive {
    public static class Params {
        ...
        public double trackWidthTicks = 12.072307626443582;

        // feedforward parameters (in tick units)
        public double kS = 1.5378642384481394;
        public double kV = 0.11208496520960586;
    ...
    public void setPower(double left_stick_y,
        ...
        y *= 1;//Helper.squareWithSign(left_stick_y); // Remember, this is reversed!
        x *= 1;//Helper.squareWithSign(left_stick_x * 1.1); // Counteract imperfect strafing
