...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 6.41680304729448; //6.41680304729448 //  y position of the parallel encoder (in tick units)
        public double perpXTicks = 2.0703455067658703; // x position of the perpendicular encoder (in tick units)
    }
