...
@Config
@TeleOp(group="Picasso", name="Blue Prop Detection Test")
//@Disabled
public class TestBluePropDetection extends LinearOpMode
{
    OpenCvWebcam webcam;
    ...
    public void runOpMode()
    {
         ...
         */
        TeamPropDeterminationPipeline.TeamPropPosition snapshotAnalysis = pipeline.getAnalysis();
